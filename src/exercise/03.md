...
The `useContext` hook allows you to pass certain props to all child components
while avoiding prop drilling. It is common to create a separate `Provider`
component to provide the props to the context, as well as a custom consumer
